...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("single_num_feature_with_na", dict(num_na_mode="min")),
        ("single_num_feature_with_na", dict(num_na_mode="max")),
        ("single_num_feature_with_na", dict(num_na_mode="include_all")),
        ("single_num_feature_with_na", dict(num_na_mode="include_best")),
        ("single_cat_feature_without_na", dict()),
        ("single_cat_feature_with_na", dict(cat_na_mode="as_category")),
